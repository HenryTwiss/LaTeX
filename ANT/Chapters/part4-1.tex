\chapter{The Theory of \texorpdfstring{$L$}{L}-functions}
  ...
  \section{Estimating the Central Value}
    ...
    \begin{theorem}
      ...
      \[
        L\left(\frac{1}{2},f\right) \ll_{\e} \left|\max_{X \ll \mf{q}(f)^{\frac{1}{2}+\e}}\left(\frac{A_{\psi}(X)}{q(f)^{\frac{1}{4}}}\right)\right|+\left|\frac{S}{q(f)^{\frac{1}{4}}}\right|,
      \]
    ...
    \begin{proof}
      ...
      But as
      \[
        \frac{1}{2}\int_{\frac{X}{2}}^{2X}A_{\psi}(u)u^{-\frac{3}{2}}\,du \ll X\max_{\frac{X}{2} \le u \le 2X}\left(A_{\psi}(u)u^{-\frac{3}{2}}\right) \ll \max_{\frac{X}{2} \le u \le 2X}\left(\frac{A_{\psi}(u)}{\sqrt{u}}\right),
      \]
      we obtain the bound
      \[
        \max_{X \ll \mf{q}(f)^{\frac{1}{2}+\e}}\left(\sum_{\frac{X}{2} \le n \le 2X}\frac{a_{f}(n)}{\sqrt{n}}\psi\left(\frac{n}{X}\right)\right) \ll \max_{X \ll \mf{q}(f)^{\frac{1}{2}+\e}}\left(\frac{A_{\psi}(X)}{\sqrt{X}}\right).
      \]
      Putting everything together gives
      \[
        \sum_{n \ge 1}\frac{a_{f}(n)}{\sqrt{n}}V_{\frac{1}{2}}\left(\frac{n}{\sqrt{q(f)}}\right) \ll_{\e} q(f)^{\frac{\e}{2}}\max_{X \ll \mf{q}(f)^{\frac{1}{2}+\e}}\left(\frac{A_{\psi}(X)}{\sqrt{X}}\right) \ll_{\e} \max_{X \ll \mf{q}(f)^{\frac{1}{2}+\e}}\left(\frac{A_{\psi}(X)}{q(f)^{\frac{1}{4}}}\right),
      \]
