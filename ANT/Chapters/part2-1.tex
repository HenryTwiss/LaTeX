\chapter{The Theory of Number Fields}
  ...
  \section{\todo{Quadratic Number Fields}}
    ...
    Since $\mc{O}_{\Q(\sqrt{d})}$ is a free abelian group of rank $2$ by \cref{thm:ring_of_integers_finitely_generated} and the squares of $\frac{1+\sqrt{d}}{2}$ and $\sqrt{d}$ belong to $\Z$, \cref{prop:ring_of_integers_quadratic} implies that
    \[
