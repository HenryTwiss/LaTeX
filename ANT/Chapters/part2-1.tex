\chapter{The Theory of Number Fields}
  ...
  \section{\todo{The Ideal Class \& Unit Groups}}
    ...
    \]
    The the ideal class and unit groups of $K$ are related via the exact sequence
    ...
    where the middle map takes any $\k \in K^{\ast}$ to its associated principal ideal $\k\mc{O}_{K}$. We can think of this map as passing from numbers to ideals. Then exactness means that unit group is measuring the contraction that takes place during this process while the class group is measuring the expansion.
