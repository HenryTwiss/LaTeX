\chapter{The Theory of Number Fields}
  ...
  \section{The Class Number \& Dirichlet's Unit Theorem}
    ...
    \subsection*{Dirichlet's Unit Theorem}
      ...
      \[
        \ell:K_{\R}^{\ast} \to \R^{r_{K}+1} \qquad (z_{\s})_{\s} \mapsto (\log|z_{\rho_{1}}|,\ldots,\log|z_{\rho_{r_{1}}}|,\log|z_{\tau_{1}}|^{2},\ldots,\log|z_{\tau_{r_{2}}}|^{2}).
      \]
      ...
      \[
        \log_{K}:K^{\ast} \to \R^{r_{K}+1} \qquad \k \mapsto (\log|\rho_{1}(\k)|,\ldots,\log|\rho_{r_{1}}(\k)|,\log|\tau_{1}(\k)|^{2},\ldots,\log|\tau_{r_{2}}(\k)|^{2}).
      \]
