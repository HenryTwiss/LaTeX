\chapter{The Theory of Number Fields}
  ...
  \section{Ramification}
    ...
    Lastly, we want to show that the number of integral ideals of a given norm is relatively small. Indeed, let $a_{K}(m)$ denote the number of integral ideals of norm $m$. Then we have the following result:
    ...
    \begin{proof}
      ...
      \[
        \Norm(\mf{a}) = p^{e_{1}\mf{f}_{p_{1}}} \cdots p^{e_{n}\mf{f}_{p_{n}}},
      \]
      ...
      \[
        e_{1}\mf{f}_{p_{1}}+\cdots+e_{n}\mf{f}_{p_{n}} = k,
      \]
      which is at most $\s_{0}(p^{k})^{n} = (k+1)^{n}$. This proves the claim in the case $m$ is a prime power. By multiplicativity of the norm and the divisor function, it follows that the number of integral ideals of norm $m$ is at most $\s_{0}(m)^{n}$ as desired.
    \end{proof}
  \section{Lattices}
