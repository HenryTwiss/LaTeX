  ...
  \section{The Work of Katz \& Sarnak}
    ...
    \begin{center}
      \begin{stabular}[1.5]{|c|c|c|}
        ...
        \hline
        \multirow{2}{*}{Orthogonal} & $\{L(s,f):\text{$f \in \mc{S}_{k}(N,\chi)$ is a primitive Hecke newform}\}$ ordered by $k$ \\& $\{L(s,f):\text{$f \in \mc{S}_{k}(N,\chi)$ is a primitive Hecke newform}\}$ ordered by $N$ \\
        \hline
