\chapter{Types of \texorpdfstring{$L$}{L}-functions}
  ...
  \section{\todo{Dedekind Zeta Functions}}
    ...
    \subsection*{\todo{The Functional Equation}}
      ...
      \]
      This shows $(s-1)\z_{K}(s)$ is of order $1$ and hence $\z_{K}(s)$ is too after removing the polar divisor. We collect our work in the following theorem:
      ...
      The matter of determining the pole of $\z_{K}(s)$ at $s = 1$ is highly nontrivial and we reserve the argument for later.
