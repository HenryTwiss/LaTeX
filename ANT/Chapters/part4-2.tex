\chapter{Types of \texorpdfstring{$L$}{L}-functions}
  ...
  \section{The Riemann Zeta Function}
    ...
    \subsection*{Jacobi's Theta Function}
      ...
      \end{equation}
      and so $\vt(z)$ is locally absolutely uniformly convergent in this region and exhibits rapid decay. The essential we will need is the \textbf{functional equation for Jacobi's theta function}\index{functional equation for Jacobi's theta function}:
    ...
    \subsection*{The Integral Representation: Part II}
      ...
      \]
      Now the functional equation for Jacobi's theta function $\vt(z)$ and \cref{equ:omega_theta_relationship_for_zeta} together imply
      \begin{align*}
  ...
  \section{Dirichlet \texorpdfstring{$L$}{L}-functions}
    ...
    \subsection*{The Integral Representation: Part I}
      ...
      \]
      defined for $z \in \H$. It is locally absolutely uniformly convergent in this region by the ratio test. Moreover, the Taylor series of $\frac{e^{y}}{1-e^{y}}$ and that of its first derivative give
      \[
        \w_{\chi}(z) = O\left(\sum_{n \ge 1}ne^{-\pi n^{2}y}\right) = O\left(\sum_{n \ge 1}ne^{-\pi ny}\right) = O(e^{-\pi y}),
      \]
      and thus $\w_{\chi}(z)$ exhibits rapid decay. Now consider the following Mellin transform:
      \[
    ...
    \subsection*{Dirichlet's Theta Function}
      ...
      \begin{proof}
        ...
        and the identity theorem finishes the proof.
      \end{proof}
      Notice that the functional equation relates $\vt_{\chi}(z)$ to $\vt_{\cchi}(z)$. Regardless, we will use it to analytically continue $L(s,\chi)$.
    \subsection*{The Integral Representation: Part II}
  ...
  \section{\todo{Dedekind Zeta Functions}}
    ...
    \subsection*{The Integral Representation: Part I}
      ...
      \[
        \w_{K}(z) = \sum_{n \ge 1}a_{K}(n)n^{r_{1}+2r_{2}}e^{\pi in^{2}z},
      \]
      defined for $z \in \H$. It is locally absolutely uniformly convergent in this region by the ratio test. Moreover, the Taylor series of the $(r_{1}+2r_{2}+1)$-th derivative of $\frac{e^{y}}{1-e^{y}}$ (by taking $\e \le 1$) gives
      \[
        \w_{K}(z) = O\left(\sum_{n \ge 1}a_{K}(n)n^{r_{1}+2r_{2}}e^{-\pi n^{2}y}\right) = O\left(\sum_{n \ge 1}n^{r_{1}+2r_{2}+1}e^{-\pi ny}\right) = O(e^{-\pi y}),
      \]
      and so $\w_{K}(z)$ exhibits rapid decay. Now consider the following Mellin transform:
      \[
        \int_{0}^{\infty}\w_{K}(iy)y^{\frac{s}{2}+\frac{r_{1}}{2}+r_{2}}\,\frac{dy}{y}.
      \]
      By the rapid decay of $\w(z)$, this integral exists and defines an analytic function for $\s > 1$. We compute
      \begin{align*}
        \int_{0}^{\infty}\w_{K}(iy)y^{\frac{s}{2}+\frac{r_{1}}{2}+r_{2}}\,\frac{dy}{y} &= \int_{0}^{\infty}\sum_{n \ge 1}a_{K}(n)n^{r_{1}+2r_{2}}e^{-\pi n^{2}y}y^{\frac{s}{2}+\frac{r_{1}}{2}+r_{2}}\,\frac{dy}{y} \\
        &= \sum_{n \ge 1}\int_{0}^{\infty}a_{K}(n)n^{r_{1}+2r_{2}}e^{-\pi n^{2}y}y^{\frac{s}{2}+\frac{r_{1}}{2}+r_{2}}\,\frac{dy}{y} && \text{DCT} \\
        &= \sum_{n \ge 1}\frac{a_{K}(n)}{\pi^{\frac{s}{2}+\frac{r_{1}}{2}+r_{2}}n^{s}}\int_{0}^{\infty}e^{-y}y^{\frac{s}{2}+\frac{r_{1}}{2}+r_{2}}\,\frac{dy}{y} && \text{$y \to \frac{y}{\pi n^{2}}$} \\
        &= \frac{\G\left(\frac{s}{2}+\frac{r_{1}}{2}+r_{2}\right)}{\pi^{\frac{s}{2}+\frac{r_{1}}{2}+r_{2}}}\sum_{n \ge 1}\frac{a_{K}(n)}{n^{s}} \\
        &= \frac{\G\left(\frac{s}{2}+\frac{r_{1}}{2}+r_{2}\right)}{\pi^{\frac{s}{2}+\frac{r_{1}}{2}+r_{2}}}\z_{K}(s).
      \end{align*}
      Therefore we have an integral representation
      \begin{equation}\label{equ:integral_representation_Dedekind_1}
        \z_{K}(s) = \frac{\pi^{\frac{s}{2}+\frac{r_{1}}{2}+r_{2}}}{\G\left(\frac{s}{2}+\frac{r_{1}}{2}+r_{2}\right)}\int_{0}^{\infty}\w_{K}(iy)y^{\frac{s}{2}+\frac{r_{1}}{2}+r_{2}}\,\frac{dy}{y}.
      \end{equation}
      We will now obtain a functional equation for $\w_{K}(z)$ which will allow us to analytically continue $\z_{K}(s)$
