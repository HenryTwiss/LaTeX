  ...
  \section{Dirichlet \texorpdfstring{$L$}{L}-functions}
    ...
    \subsection*{The Dirichlet Theta Function}
      ...
      \begin{proof}
        ...
        \]
        Then $f(x)$ is of Schwarz class because it exhibits exponential decay. By \cref{prop:Fourier_transform_properties} (i)-(iv) and \cref{prop:Fourier_transform_of_exponential}, we have
        \[
