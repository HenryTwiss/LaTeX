\chapter{Types of \texorpdfstring{$L$}{L}-functions}
  ...
  \section{\todo{Dedekind Zeta Functions}}
    ...
    \subsection*{\todo{The Hecke Theta Function}}
      ...
      \]
      for $\mathbf{z} \in \H^{r_{K}+1}$. \todo{Absolute convergence and exponential decay properties}. Establishing the relationship to $\w_{S}(\mathbf{z})$ will require some work. Consider the isomorphism
      \[
