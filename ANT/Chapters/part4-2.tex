    ...
    \subsection*{The Jacobi Theta Function}
      ...
      \begin{proof}
        ...
        \[
          f(x) = e^{-2\pi x^{2}y}.
        \]
        Then $f(x)$ is of Schwarz class because it exhibits exponential decay. By \cref{prop:Fourier_transform_of_exponential}, we have
        \[
  ...
  \section{Dirichlet \texorpdfstring{$L$}{L}-functions}
    ...
    \subsection*{The Dirichlet Theta Function}
      ...
      \begin{proof}
        ...
        \]
        Then $f(x)$ is of Schwarz class because it exhibits exponential decay. By \cref{prop:Fourier_transform_properties} (i)-(iii) and \cref{prop:Fourier_transform_of_exponential}, we have
        \[
          (\mc{F}f)(t) = \left(\frac{t\todo{i}}{2q\sqrt{y}}\right)^{\d_{\chi}}\frac{e^{\frac{2\pi iat}{q}-\frac{\pi t^{2}}{2q^{2}y}}}{\sqrt{2}qy^{\frac{1+\d_{\chi}}{2}}}.
        \]
        Then the Poisson summation formula and the identity theorem together imply
        \[
          I_{a}(z) = \sum_{m \in \Z}(mq+a)^{\d_{\chi}}e^{2\pi i(mq+a)^{2}z} = \sum_{t \in \Z}\left(\frac{t}{2qi\sqrt{-iz}}\right)^{\d_{\chi}}\frac{e^{\frac{2\pi iat}{q}-\frac{\pi it^{2}}{2q^{2}z}}}{\sqrt{2}q(-iz)^{\frac{1+\d_{\chi}}{2}}}.
        \]
        Plugging this back into the definition of $\vt_{\chi}(z)$ yields
        \begin{align*}
          \vt_{\chi}(z) &= \sum_{a \tmod{q}}\chi(a)\sum_{t \in \Z}\left(\frac{t}{2qi\sqrt{-iz}}\right)^{\d_{\chi}}\frac{e^{\frac{2\pi iat}{q}-\frac{\pi it^{2}}{2q^{2}z}}}{\sqrt{2}q(-iz)^{\frac{1+\d_{\chi}}{2}}} \\
