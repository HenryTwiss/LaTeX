\chapter{Types of Sieves}
  \section{\todo{Brun's Pure Sieve}}
    ...
    \end{equation}
    is $r$ is even. Thus \cref{equ:iterative_Buchstab} gives upper and lower bounds for hte sifting function depending on the parity of $r$. Then for a fixed $r \ge 1$, \textbf{Brun's pure sieve}\index{Brun's pure sieve} $\L = (\l_{d})_{d \ge 1}$ is given by
    \[
