\chapter{Types of \texorpdfstring{$L$}{L}-functions}
  ...
  \section{The Riemann Zeta Function}
    ...
    \subsection*{The Integral Representation: Part I}
      ...
      \]
      defined for $z \in \H$. It is locally absolutely uniformly convergent in this region by the ratio and Weierstrass $M$-tests. Moreover, the Taylor series of $\frac{e^{y}}{1-e^{y}}$ gives
      \[
        \w(z) = O\left(\sum_{n \ge 1}e^{-\pi n^{2}y}\right) = O\left(\sum_{n \ge 1}e^{-\pi ny}\right) = O(e^{-\pi y}),
      \]
      and so $\w(z)$ exhibits rapid decay. Now consider the following Mellin transform:
      \[
        \int_{0}^{\infty}\w(iy)y^{\frac{s}{2}}\,\frac{dy}{y}.
      \]
      By the rapid decay of $\w(z)$, this integral exists and defines an analytic function for $\s > 1$. Then we compute
      \begin{align*}
      ...
      \end{equation}
      Unfortunately, we cannot proceed until we obtain a functional equation for $\w(z)$. So we will make a slight detour and come back to the integral representation after.
    \subsection*{The Jacobi Theta Function}
      ...
      \begin{proof}
        ...
        \[
          (\mc{F}f)(t) = \int_{\R}f(x)e^{-2\pi itx}\,dx = \int_{\R}e^{-2\pi x^{2}y}e^{-2\pi itx}\,dx = \int_{\R}e^{-2\pi(x^{2}y+itx)}\,dx.
        \]
        Making the change of variables $x \to \frac{x}{\sqrt{y}}$, the last integral above becomes
        \[
          \frac{1}{\sqrt{y}}\int_{\R}e^{-2\pi\left(x^{2}+\frac{itx}{\sqrt{y}}\right)}.
        \]
        ...
        \[
          \frac{e^{-\frac{\pi t^{2}}{2y}}}{\sqrt{y}}\int_{\R}e^{-2\pi\left(x+\frac{it}{2\sqrt{y}}\right)^{2}}\,dx.
        \]
        ...
        \[
          \frac{e^{-\frac{\pi t^{2}}{2y}}}{\sqrt{2y}}\int_{\R}e^{-\pi x^{2}}\,dx = \frac{e^{-\frac{\pi t^{2}}{2y}}}{\sqrt{2y}},
        \]
  ...
  \section{Dirichlet \texorpdfstring{$L$}{L}-functions}
    ...
    \subsection*{The Integral Representation: Part I}
      ...
      \]
      defined for $z \in \H$. It is locally absolutely uniformly convergent in this region by the ratio and Weierstrass $M$-tests. Moreover, the Taylor series of $\frac{e^{y}}{1-e^{y}}$ and its derivative together give
      \[
        \w_{\chi}(z) = O\left(\sum_{n \ge 1}ne^{-\pi n^{2}y}\right) = O\left(\sum_{n \ge 1}ne^{-\pi ny}\right) = O(e^{-\pi y}),
      \]
      and so $\w_{\chi}(z)$ exhibits rapid decay. Now consider the following Mellin transform:
      \[
      ...
      \begin{align*}
        ...
        &= \sum_{n \ge 1}\int_{0}^{\infty}\chi(n)n^{\mf{a}}e^{-\pi n^{2}y}y^{\frac{s+\mf{a}}{2}}\,\frac{dy}{y} && \text{FT} \\
    ...
    \subsection*{The Dirichlet Theta Function}
      ...
      \begin{proof}
        ...
        \[
          (\mc{F}f)(t) = \int_{\R}f(x)e^{-2\pi itx}\,dx = \int_{\R}(xq+a)^{\mf{a}}e^{-2\pi(xq+a)^{2}y}e^{-2\pi itx}\,dx = \int_{\R}(xq+a)^{\mf{a}}e^{-2\pi((xq+a)^{2}y+itx)}\,dx.
        \]
        By performing the change of variables $x \to \frac{x}{q\sqrt{y}}-\frac{a}{q}$, the last integral above becomes
        \[
          \frac{e^{\frac{2\pi iat}{q}}}{qy^{\frac{1+\mf{a}}{2}}}\int_{\R}x^{\mf{a}}e^{-2\pi\left(x^{2}+\frac{itx}{q\sqrt{y}}\right)}\,dx.
        \]
        ...
        Taking exponentials, this implies that the previous integral is equal to
        \[
          \frac{e^{\frac{2\pi iat}{q}-\frac{\pi t^{2}}{2q^{2}y}}}{qy^{\frac{1+\mf{a}}{2}}}\int_{\R}x^{\mf{a}}e^{-2\pi\left(x+\frac{it}{2q\sqrt{y}}\right)^{2}}\,dx.
        \]
        ...
        \[
          \frac{e^{\frac{2\pi iat}{q}-\frac{\pi t^{2}}{2q^{2}y}}}{\sqrt{2}qy^{\frac{1+\mf{a}}{2}}}\int_{\R}\left(\frac{x}{\sqrt{2}}-\frac{it}{2q\sqrt{y}}\right)^{\mf{a}}e^{-\pi x^{2}}\,dx = \frac{e^{\frac{2\pi iat}{q}-\frac{\pi t^{2}}{2q^{2}y}}}{\sqrt{2}qy^{\frac{1+\mf{a}}{2}}}\int_{\R}\left(\frac{x}{\sqrt{2}}+\frac{t}{2qi\sqrt{y}}\right)^{\mf{a}}e^{-\pi x^{2}}\,dx.
        \]
        If $\mf{a} = 0$, we obtain
        \begin{equation}\label{transformation_law_for_twisted_Jacobi_theta_function_1}
          \frac{e^{\frac{2\pi iat}{q}-\frac{\pi t^{2}}{2q^{2}y}}}{\sqrt{2}qy^{\frac{1+\mf{a}}{2}}}\int_{\R}e^{-\pi x^{2}}\,dx = \frac{e^{\frac{2\pi iat}{q}-\frac{\pi t^{2}}{2q^{2}y}}}{\sqrt{2}qy^{\frac{1+\mf{a}}{2}}},
        \end{equation}
        ...
        \[
          \int_{\R}\frac{x}{\sqrt{2}}e^{-\pi x^{2}}\,dx = -\frac{1}{\sqrt{8}\pi}e^{-\pi x^{2}}\bigg|_{-\infty}^{\infty} = 0,
        \]
        and
        \begin{equation}\label{transformation_law_for_twisted_Jacobi_theta_function_2}
          \frac{e^{\frac{2\pi iat}{q}-\frac{\pi t^{2}}{2q^{2}y}}}{\sqrt{2}qy^{\frac{1+\mf{a}}{2}}}\int_{\R}\left(\frac{t}{2qi\sqrt{y}}\right)e^{-\pi x^{2}}\,dx = \frac{e^{\frac{2\pi iat}{q}-\frac{\pi t^{2}}{2q^{2}y}}}{\sqrt{2}qy^{\frac{1+\mf{a}}{2}}}\left(\frac{t}{2qi\sqrt{y}}\right)\int_{\R}e^{-\pi x^{2}}\,dx = \frac{e^{\frac{2\pi iat}{q}-\frac{\pi t^{2}}{2q^{2}y}}}{\sqrt{2}qy^{\frac{1+\mf{a}}{2}}}\left(\frac{t}{2qi\sqrt{y}}\right),
        \end{equation}
        where the last equality follows because the last integral is the Gaussian integral again. Since $\left(\frac{t}{2qi\sqrt{y}}\right)^{\mf{a}} = 1$ if $\mf{a} = 0$, \cref{transformation_law_for_twisted_Jacobi_theta_function_1,transformation_law_for_twisted_Jacobi_theta_function_2} together imply
        \[
          (\mc{F}f)(t) = \frac{e^{\frac{2\pi iat}{q}-\frac{\pi t^{2}}{2q^{2}y}}}{\sqrt{2}qy^{\frac{1+\mf{a}}{2}}}\left(\frac{t}{2qi\sqrt{y}}\right)^{\mf{a}}.
        \]
        By the Poisson summation formula, we have
        \begin{align*}
  ...
  \section{\todo{Dedekind Zeta Functions}}
    \subsection*{The Definition \& Euler Product}
      ...
      \[
        \z_{K}(s) = \sum_{\mf{a}}\frac{1}{\Norm(\a)^{s}},
      \]
    ...
    \subsection*{\todo{The Integral Representation: Part I}}
    ...
    \subsection*{\todo{The Functional Equation}}
      ...
      \begin{theorem}\label{thm:Dedekind_Selberg}
        ...
        \]
        and has a simple pole at $s = 1$ of reside $\frac{2^{r_{1}}(2\pi)^{r_{2}}R_{K}h_{K}}{w_{K}\sqrt{|\D_{K}|}}$.
      \end{theorem}
  ...
  \section{Hecke-Maass \texorpdfstring{$L$}{L}-functions}
    ...
    \subsection*{The Integral Representation}
      ...
      \]
      As $f$ has rapid decay at the cusps, this integral exists and defines an analytic function for $\s > 1$. The derivative operator is present because if $f$ is odd, $\SC(x) = i\sin(x)$. In any case, the smoothness of $f$ implies that we may differentiate its Fourier-Whittaker series termwise to obtain
      \[
    ...
    \subsection*{The Functional Equation}
      An immediate consequence of applying the symmetry $s \to 1-s$ to the integral representation is the following functional equation:
      \[
        N^{\frac{s}{2}}\frac{\G\left(\frac{s+\mf{a}+\nu}{2}\right)\G\left(\frac{s+\mf{a}-\nu}{2}\right)}{2^{2-\mf{a}}\pi^{s}(-i)^{\mf{a}}}L(s,f) = \w_{N}(f)(-1)^{\mf{a}}N^{\frac{1-s}{2}}\frac{\G\left(\frac{(1-s)+\mf{a}+\nu}{2}\right)\G\left(\frac{(1-s)+\mf{a}-\nu}{2}\right)}{2^{2-\mf{a}}\pi^{1-s}(-i)^{\mf{a}}}L(1-s,\conj{f}).
      \]
  ...
  \section{The Rankin-Selberg Method}
    ...
    \subsection*{The Integral Representation: Part II}
      ...
      \begin{proof}
        ...
        \begin{align*}
          (\mc{F}f)(t) = \int_{\R}f(x)e^{-2\pi itx}\,dx &= \int_{\R}\frac{y^{s}}{|cx+r+icy|^{2s}}e^{-2\pi itx}\,dx \\
          &= \int_{\R}\frac{y^{s}}{((cx+r)^{2}+(cy)^{2})^{s}}e^{-2\pi itx}\,dx \\
          &= e^{2\pi it\frac{r}{c}}\int_{\R}\frac{y^{s}}{((cx)^{2}+(cy)^{2})^{s}}e^{-2\pi itx}\,dx && \text{$x \to x-\frac{r}{c}$} \\
          &= \frac{e^{2\pi it\frac{r}{c}}}{c^{2s}}\int_{\R}\frac{y^{s}}{(x^{2}+y^{2})^{s}}e^{-2\pi itx}\,dx \\
          &= \frac{e^{2\pi it\frac{r}{c}}}{c^{2s}}\int_{\R}\frac{y^{s+1}}{((xy)^{2}+y^{2})^{s}}e^{-2\pi itxy}\,dx && \text{$x \to xy$} \\
          &= \frac{e^{2\pi it\frac{r}{c}}}{c^{2s}}\int_{\R}\frac{y^{1-s}}{(x^{2}+1)^{s}}e^{-2\pi itxy}\,dx.
        \end{align*}
    ...
    \subsection*{The Integral Representation: Part III}
    ...
    \subsection*{The Rankin-Selberg Method}
      ...
      \]
      where $a_{f \ox g}(n) = \sum_{n = m\ell^{2}}\chi\conj{\psi}(\ell^{2})a_{f}(m)\conj{a_{g}(m)}$. The following is the \textbf{Rankin-Selberg method}\index{Rankin-Selberg method} (see \todo{cite} for a proof):
