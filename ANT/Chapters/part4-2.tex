\chapter{Types of \texorpdfstring{$L$}{L}-functions}
  ...
  \section{The Riemann Zeta Function}
    ...
    \subsection*{The Integral Representation: Part I}
      ...
      \]
      defined for $z \in \H$. It is locally absolutely uniformly convergent in this region by the ratio test. Moreover, the Taylor series of $\frac{e^{y}}{1-e^{y}}$ gives
      \[
  ...
  \section{Dirichlet \texorpdfstring{$L$}{L}-functions}
    ...
    \subsection*{The Integral Representation: Part I}
      ...
      \]
      defined for $z \in \H$. It is locally absolutely uniformly convergent in this region by the ratio test. Moreover, the Taylor series of $\frac{e^{y}}{1-e^{y}}$ and its first derivative together give
      \[
  ...
  \section{\todo{Dedekind Zeta Functions}}
    \subsection*{The Definition \& Euler Product}
      ...
      \]
      with local roots $\w_{p,i}^{k}$.
    \subsection*{\todo{The Integral Representation: Part I}}
      To find an integral representation for $\z_{K}(s)$, consider the function
      \[
        \w_{K}(\mathbf{z}) = \sum_{\mathbf{n} \in \Z_{ \ge 0}^{d}-\{\mathbf{0}\}}\todo{xxx}e^{\pi i|\mathbf{n}|^{2}z},
      \]
      defined for $\mathbf{z} \in \H^{d}$.
