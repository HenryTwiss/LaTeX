\chapter{Types of \texorpdfstring{$L$}{L}-functions}
  ...
  \section{\todo{Dedekind Zeta Functions}}
    \subsection*{The Definition \& Euler Product}
      ...
      \]
      where the sum is over all integral ideals of $K$. Since the norm is completely multiplicative by \cref{prop:ideal_norm_is_multiplicative}, we can express $\z_{K}(s)$ as the infinite product
      \[
      ...
      \[
        n = \sum_{1 \le r_{p}}f_{\mf{p}_{i}}.
      \]
      In particular, at least one prime does. Therefore, letting $\w_{p,i}$ be a primitive $f_{\mf{p}_{i}}$-th root of unity, we have the degree $n$ Euler product:
      \[
    ...
    \subsection*{\todo{The Dedekind Theta Function}}
