...
\chapter{Miscellaneous}
  \section{Representation Theory}\label{append:Representation_Theory}
    ...
    We will only need one very useful theorem about representations when $G$ is a finite abelian group and $V$ is a vector space over $\C$. In this case $G$ has a group of characters, and the underlying vector space $V$ is completely reducible with respect to the characters of $G$:
