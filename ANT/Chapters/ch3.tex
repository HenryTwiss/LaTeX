  ...
  \section{The Mellin Transform \& Theta Functions}
    ...
    \subsection*{\texorpdfstring{$L$}{L}-functions From Theta Functions}
      ...
      \begin{method}
        ...
        \]
        that is absolutely uniformly convergent on compacta for $\Re(s) > 1$, and there is a theta function $\w_{f}(s)$ such that $L(s,f)$ is approximately the Mellin transform of $\w_{f}(s)$. That is, 
        \[
