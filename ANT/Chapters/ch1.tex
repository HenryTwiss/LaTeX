    ...
    \section{Dirichlet Characters}
      ...
      \phantom{ }
        \begin{enumerate}[label=(\roman*)]
          ...
          \]
          \item For any two integers $a$ and $b$ taken modulo $m$,
          \[
      ...
      \begin{proof}
        ...
        \begin{enumerate}[label=(\roman*)]
          ...
          \]
          Therefore $\psi(a)\conj{\psi}(b)S = S$ so that $S = 0$ unless $(ab,m) = 1$ and $\psi(a)\conj{\psi}(b) = \psi(a\conj{b}) = 1$ for all Dirichlet characters $\psi$ modulo $m$. Given $(ab,m) = 1$, this last condition happens if and only if $a \equiv b \tmod{m}$ in which case $S = 1$. This proves (ii).
        \end{enumerate}
      \end{proof}
      ...
      \phantom{ }
        \begin{enumerate}[label=(\roman*)]
          ...
          \]
          \item For any integer $a$ taken modulo $m$,
          \[
