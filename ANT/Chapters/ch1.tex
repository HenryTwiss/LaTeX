    ...
    \section{Dirichlet Characters}
      ...
      \begin{proof}
        ...
        \begin{enumerate}[label=(\roman*)]
          ...
          \]
          Therefore $\psi(a)\conj{\psi}(b)S = S$ so that $S = 0$ unless $\psi(a)\conj{\psi}(b) = \psi(a\conj{b}) = 1$ for all Dirichlet characters $\psi$ modulo $m$. This happens if and only if $a \equiv b \tmod{m}$ in which case $S = 1$. This proves (ii).
        \end{enumerate}
      \end{proof}
