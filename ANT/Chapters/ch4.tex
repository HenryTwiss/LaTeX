  \chapter{Additional Results}
    ...
    \section{The Petersson Trace Formula}
      From \cref{thm:newforms_characterization_modular}, $\mc{S}_{k}(N,\chi)$ admits an orthonormal basis of primitive Hecke eigenforms. Call this basis $\{u_{j}\}_{1 \le j \le r}$ where $r$ is the dimension of $\mc{S}_{k}(N,\chi)$. Each of these cusp forms admits a Fourier series
      \[
