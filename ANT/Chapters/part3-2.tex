\chapter{Types of \texorpdfstring{$L$}{L}-functions}
    ...
    \subsection*{The Rankin-Selberg Method}
      ...
      \begin{method}[Rankin-Selberg method]
        ...
        \begin{enumerate}[label=(\roman*)]
          ...
          \item The Ramanujan-Petersson holds if $f$ and $g$ are Heck-Maass eigenforms.
        \end{enumerate}
  ...
  \section{Applications of the Rankin-Selberg Method}
    ...
    \subsection*{Strong Multiplicity One}
      Let $f$ be a primitive Hecke or Hecke-Maass eigenform. Recall that the multiplicty one theorem states that $f$ is determined by its Fourier coefficients at primes. The \textbf{strong multiplicity one}\index{strong multiplicity one} theroem says that we can do better:
