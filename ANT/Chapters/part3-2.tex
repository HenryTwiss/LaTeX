\chapter{Types of \texorpdfstring{$L$}{L}-functions}
  ...
  \section{Hecke \texorpdfstring{$L$}{L}-functions}
    ...
    \subsection*{The Functional Equation \& Critical Strip of \texorpdfstring{$L(s,f)$}{L(s,f)}}
      ...
      \]
      with $\k_{1} = k-1$ and $\k_{2} = k+1$ the local roots at infinity. The conductor is $q(f) = N$, so the primes dividing the level ramify, and by the Ramanujan-Petersson conjecture, $\a_{1}(p) \neq 0$ and $\a_{2}(p) \neq 0$ for all primes $p \nmid N$. The completed $L$-function is
      \[
  ...
  \section{Hecke-Maass \texorpdfstring{$L$}{L}-functions}
    \subsection*{The Definition \& Euler Product of \texorpdfstring{$L(s,f)$}{L(s,f)}}
      We will investigate the $L$-functions of Maass cusp forms. Let $f \in \mc{C}_{r}(N,\chi)$ be even or odd and denote its Fourier series by
      \[
        f(z) = \sum_{n \ge 1}a_{f}(n)\sqrt{y}K_{ir}(2\pi ny)\SC(2\pi nx).
      \]
    ...
    \subsection*{The Integral Representation of \texorpdfstring{$L(s,f)$}{L(s,f)}}
      ...
      \[
        \left(\frac{\del}{\del x}^{\mf{a}}f\right)(z) = \sum_{n \ge 1}a_{f}(n)(2\pi n)^{\mf{a}}\sqrt{y}K_{ir}(2\pi ny)\cos(2\pi nx).
      \]
      ...
      \begin{align*}
        \int_{0}^{\infty}\left(\frac{\del}{\del x}^{\mf{a}}f\right)(iy)y^{s-\frac{1}{2}+\mf{a}}\,\frac{dy}{y} &= \int_{0}^{\infty}\sum_{n \ge 1}a_{f}(n)(2\pi n)^{\mf{a}}K_{ir}(2\pi ny)y^{s+\mf{a}}\,\frac{dy}{y} \\
        &= \sum_{n \ge 1}a_{f}(n)(2\pi n)^{\mf{a}}\int_{0}^{\infty}K_{ir}(2\pi ny)y^{s+\mf{a}}\,\frac{dy}{y} &&\text{DCT} \\
        &= \sum_{n \ge 1}\frac{a_{f}(n)}{(2\pi)^{s}n^{s}}\int_{0}^{\infty}K_{ir}(y)y^{s+\mf{a}}\,\frac{dy}{y} &&\text{$y \to \frac{y}{2\pi n}$} \\
        &= \frac{\G\left(\frac{s+\mf{a}+ir}{2}\right)\G\left(\frac{s+\mf{a}-ir}{2}\right)}{2^{2-\mf{a}}\pi^{s}}\sum_{n \ge 1}\frac{a_{f}(n)}{n^{s}} && \text{\cref{append:Special_Integrals}} \\
        &= \frac{\G\left(\frac{s+\mf{a}+ir}{2}\right)\G\left(\frac{s+\mf{a}-ir}{2}\right)}{2^{2-\mf{a}}\pi^{s}}L(s,f).
      \end{align*}
      ...
      \begin{equation}\label{equ:integral_representation_Maass_1}
        L(s,f) = \frac{2^{2-\mf{a}}\pi^{s}}{\G\left(\frac{s+\mf{a}+ir}{2}\right)\G\left(\frac{s+\mf{a}-ir}{2}\right)}\int_{0}^{\infty}\left(\frac{\del}{\del x}^{\mf{a}}f\right)(iy)y^{s-\frac{1}{2}+\mf{a}}\,\frac{dy}{y}.
      \end{equation}
      Now split the integral on the right-hand side into two pieces
      ...
      \begin{align*}
        \left(\frac{\del}{\del x}^{\mf{a}}\w_{N}f\right)(z) &= \left(\frac{\del}{\del x}^{\mf{a}}\right)f\left(-\frac{1}{Nz}\right) \\
         &= \left(\frac{\del}{\del x}^{\mf{a}}\right)\sum_{n \ge 1}a_{f}(n)\sqrt{\frac{y}{N|z|^{2}}}K_{ir}(2\pi ny)\SC\left(-2\pi n\frac{x}{N|z|^{2}}\right) \\
        &= (-N|z|^{2})^{-\mf{a}}\sum_{n \ge 1}a_{f}(n)(2\pi n)^{\mf{a}}\sqrt{\frac{y}{N|z|^{2}}}K_{ir}\left(2\pi n\frac{y}{N|z|^{2}}\right)\cos\left(-2\pi n\frac{x}{N|z|^{2}}\right) \\
      ...
      \begin{align*}
        L(s,f) &= \frac{2^{2-\mf{a}}\pi^{s}}{\G\left(\frac{s+\mf{a}+ir}{2}\right)\G\left(\frac{s+\mf{a}-ir}{2}\right)} \\
    ...
    \subsection*{The Functional Equation \& Critical Strip of \texorpdfstring{$L(s,f)$}{L(s,f)}}
      An immediate consequence of applying the symmetry $s \to 1-s$ to the integral representation is the following functional equation:
      \[
        \frac{\G\left(\frac{s+\mf{a}+ir}{2}\right)\G\left(\frac{s+\mf{a}-ir}{2}\right)}{2^{2-\mf{a}}\pi^{s}}L(s,f) = \w_{N}(f)(-1)^{\mf{a}}N^{-\frac{s}{2}}\frac{\G\left(\frac{(1-s)+\mf{a}+ir}{2}\right)\G\left(\frac{(1-s)+\mf{a}-ir}{2}\right)}{2^{2-\mf{a}}\pi^{1-s}}L(1-s,\conj{f}).
      \]
      ...
      \[
        \g(s,f) = \pi^{-s}\G\left(\frac{s+\mf{a}+ir}{2}\right)\G\left(\frac{s+\mf{a}-ir}{2}\right),
      \]
      with $\k_{1} = \mf{a}+ir$ and $\k_{2} = \mf{a}-ir$ the local roots at infinity. The conductor is $q(f) = N$, so the primes dividing the level ramify, and by the Ramanujan-Petersson conjecture, $\a_{1}(p) \neq 0$ and $\a_{2}(p) \neq 0$  for all primes $p \nmid N$. The completed $L$-function is
      \[
        \L(s,f) = N^{-\frac{s}{2}}\pi^{-s}\G\left(\frac{s+\mf{a}+ir}{2}\right)\G\left(\frac{s+\mf{a}-ir}{2}\right)L(s,f),
      \]
      with functional equation
      \[
      ...
      \begin{theorem}\label{equ:thm:primitive_Hecke-Maass_Selberg}
        For any even or odd primitive Hecke-Maass eigenform $f \in \mc{C}_{r}(N,\chi)$, $L(s,f)$ is a Selberg class $L$-function provided the Ramanujan-Petersson conjecture holds. For $\s > 1$, it has a degree $2$ Euler product given by 
        \[
          L(s,f) = \prod_{p \nmid N}(1-a_{f}(p)p^{-s}+\chi(p)p^{-2s})^{-1}\prod_{p \mid N}(1-a_{f}(p)p^{-s})^{-1}.
        \]
        Moreover, it admits analytic continuation to $\C$ via the integral representation
        ...
        and possesses the functional equation
        \[
          N^{-\frac{s}{2}}\pi^{-s}\G\left(\frac{s+\mf{a}+ir}{2}\right)\G\left(\frac{s+\mf{a}-ir}{2}\right)L(s,f) = \L(s,f) = \w_{N}(f)(-1)^{\mf{a}}\L(1-s,\conj{f}).
        \]
      \end{theorem}
    \subsection*{Beyond Primitivity of of \texorpdfstring{$L(s,f)$}{L(s,f)}}
      ...
      \begin{theorem}\label{thm:analytic_continuation_Hecke-Maass}
        For any even or odd $f \in \mc{C}_{r}(\G_{1}(N))$, $L(s,f)$ admits analytic continuation to $\C$.
      \end{theorem}
      \begin{proof}
  ...
  \section{The Rankin-Selberg Method}
    ...
    \subsection*{The Rankin-Selberg Method}
      The Rankin-Selberg method is much more complicated in general, but the argument is essentially the same. Let $f$ and $g$ both be primitive Hecke or Heck-Maass eigenforms with Fourier coefficients $a_{f}(n)$ and $a_{g}(n)$ respectively. We suppose $f$ has weight $k$/eigenvalue $\l$ and spectral parameter $r$, level $N$, and character $\chi$, and $g$ has weight $\ell$/eigenvalue $\nu$ and spectral parameter $u$, level $M$, and character $\psi$. 
      The $L$-function $L(s,f \x g)$ of $f$ and $g$ is given by the $L$-series
      \[
      ...
      \begin{method}[Rankin-Selberg method]
        ...
        \begin{enumerate}[label=(\roman*)]
          \item $f$ has weight $k$/eigenvalue $\l$ and spectral parameter $r$, level $N$, and character $\chi$.
      ...
      We make a few remarks about the Rankin-Selberg method. Local absolute uniform convergence for $\s > 1$ (we must assume the Ramanujan-Petersson conjecture in the Maass form case) are proved in the exactly the same way as we have described. The argument for the Euler product is also similar. However, if either $N > 1$ or $M > 1$, the computation becomes more difficult to compute since the local $p$ factors for $p \mid NM$ change. Moreover, the situation is increasingly complicated if $(N,M) > 1$ since conductor dropping can occur. The integral representation has a similar argument, but if the weights/eigenvalues and spectral parameters are distinct the resulting Eisenstein series becomes more complicated. In particular, it is on $\G_{0}(NM)\backslash\H$ and if $NM > 1$, then there is more than just the cusp at $\infty$. Therefore the functional equation of the Eisenstein series at the $\infty$ cusp then reflects into a linear combination of Eisenstein series at the other cusps. This results in the requirement to compute the Fourier coefficients of all of these Eisenstein series. Moreover, this procedure can be generalized to remove the primitive Hecke and/or primitive Hecke-Maass eigenform conditions by taking linear combinations, but we won't attempt discussing this further. 
  \section{Applications of the Rankin-Selberg Method}
    ...
    \subsection*{Strong Multiplicity One}
      Let $f$ be a primitive Hecke or Hecke-Maass eigenform. Then $f$ is determined by Hecke eigenvalues at primes for fixed weight/eigenvalue and spectral parameter, and level. Using Rankin-Selberg convolutions, we can prove \textbf{strong multiplicity one}\index{strong multiplicity one} for holomorphic or Maass forms which says that $f$ is determined by Hecke eigenvalues at all but finitely many primes for fixed weight/eigenvalue and spectral parameter, level, and character:

      \begin{theorem}[Strong multiplicity one, holomorphic and Maass versions]
        Let $f$ and $g$ both be primitive Hecke or Hecke-Maass eigenforms of the same weight/eigenvalue and spectral parameter, level, and character. Denote the Hecke eigenvalues by $\l_{f}(n)$ and $\l_{g}(n)$ respectively. If $a_{f}(p) = a_{g}(p)$ for all but finitely many primes $p$, then $f = g$.
      \end{theorem}
      \begin{proof}
        ...
        \]
        But as $f$ and $g$ have the same the weight/eigenvalue and spectral parameter, level, and character, and $\l_{f}(p) = \l_{g}(p)$ for all $p \notin S$, we have
        \[
