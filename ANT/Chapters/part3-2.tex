\chapter{Types of \texorpdfstring{$L$}{L}-functions}
  ...
  \section{The Rankin-Selberg Method}
    ...
    \subsection*{The Fourier Series and Functional Equation of \texorpdfstring{$E(z,s)$}{E(z,s)}}
      Recall that $E(z,s)$ has a Fourier series of the form
      \[
        E(z,s) = a^{+}(0,s)y^{s}+a^{-}(0,s)y^{1-s}+\sum_{n \neq 0}a(n,s)\sqrt{y}K_{s-\frac{1}{2}}(2\pi|n|y)e^{2\pi inx}.
      \]
      Writing the Fourier series in the more compressed form
      \[
        E(z,s) = a(0,y,s)+\sum_{n \neq 0}a(n,y,s)e^{2\pi inx},
      \]
      we will compute these latter Fourier coefficients. To do this we will need the following technical lemma:
