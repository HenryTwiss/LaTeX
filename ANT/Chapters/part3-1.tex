  ...
  \section{Zero Density}
    ...
    \begin{proof}
      ...
      \begin{enumerate}[label=(\roman*)]
        ...
        \]
        Applying the explicit formula for the logarithmic derivative to the two terms on the right hand side and using that $\frac{\g'}{\g}(s,f) \ll \log{\mathfrak{q}_{\infty}(s,f)}$, we get
        \[
