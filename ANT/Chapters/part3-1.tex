\chapter{The Theory of \texorpdfstring{$L$}{L}-functions}
  ...
  \section{The Lindel\"of Hypothesis \& Convexity Bounds}
    ...
    \end{equation}
    in the vertical strip $-\e \le \s \le 1+\e$. At the critical line \cref{equ:convexity_bound_for_L_function_in_critial_strip} gives the following \textbf{convexity bound}\index{convexity bound}:
