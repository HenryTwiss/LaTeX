\chapter{The Theory of \texorpdfstring{$L$}{L}-functions}
  ...
  \section{The Explicit Formula for the Logarithmic Derivative}
    ...
    The formula for the logarithmic derivative in \cref{prop:explicit_formula_log_derivative} it called the \textbf{explicit formula for the logarithmic derivative}\index{explicit formula for the logarithmic derivative} of $L(s,f)$. In general, the estimation of the constants $A(f)$ and $B(f)$ can be challenging and heavily depends upon the arithmetic object $f$. We will often need to estimate them on a case-by-case basis.
  \section{\todo{A Zero-free Region}}
  \section{\todo{Zero Counting}}
