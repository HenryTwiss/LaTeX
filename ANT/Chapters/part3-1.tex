\chapter{The Theory of \texorpdfstring{$L$}{L}-functions}
  ...
  \section{Analytic Data of \texorpdfstring{$L$}{L}-functions}
    ...
    \end{itemize}
    A few additional comments are in order. The \textbf{critical strip}\index{critical strip} is the strip
    \[
