\chapter{The Theory of \texorpdfstring{$L$}{L}-functions}
  ...
  \section{Zero Density}
    ...
    \begin{proof}
      ...
      \[
        \frac{N(T,f)}{T} = \frac{1}{\pi}\log\left(\frac{T^{d_{f}}}{(2\pi e)^{d_{f}}}\right)\left(1+O\left(\frac{\log{\mf{q}(iT,f)}}{\log\left(\frac{T^{d_{f}}}{(2\pi e)^{d_{f}}}\right)T}\right)\right) = \frac{1}{\pi}\log\left(\frac{T^{d_{f}}}{(2\pi e)^{d_{f}}}\right)\left(1+O\left(\frac{1}{T}\right)\right).
      \]
