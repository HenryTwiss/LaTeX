\chapter{The Theory of \texorpdfstring{$L$}{L}-functions}
  ...
  \section{The Lindel\"of Hypothesis \& Convexity Arguments}
    ...
    \]
    Estimating the left-hand side can be acomplished using Perron-type formulas for the sums and the residue term can usually be computed outright or estimated.