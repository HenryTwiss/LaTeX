  ...
  \section{Zero Density}
    ...
    \begin{lemma}\label{lem:powerful_L-function_approximation_lemma}
      ...
      \begin{enumerate}[label=(\roman*)]
        ...
        \]
        for any $s$ in the vertical strip $-\frac{1}{2} \le \s \le 2$ that is not a pole or zero of $L(s,f)$. Moreover,
        \[
        ...
        \]
        in the same region and we may disregard any term in either sum provided $1 < \s \le 2$.
      \end{enumerate}
    \end{lemma}
    \begin{proof}
      ...
      \begin{enumerate}[label=(\roman*)]
        ...
        \item To deduce (iv), let $s$ belong to the vertical strip $-\frac{1}{2} \le \s \le 2$ such that $s$ is not a pole or zero of $L(s,f)$. Using \cref{equ:log_derivative_bound_conductor}, we can write
        \[
        ...
        \]
        Now observe that we can disregard any of the terms in either sum provided $1 < \s \le 2$ by (iii).
      \end{enumerate}
    \end{proof}
