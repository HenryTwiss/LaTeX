\chapter{The Theory of \texorpdfstring{$L$}{L}-functions}
  ...
  \section{Analytic Data of \texorpdfstring{$L$}{L}-functions}
    ...
    \begin{remark}
      In the literature it is common to refer to $L$-series satisfying a subset of the properties of $L$-functions as $L$-functions as well. The most common occurrence is when $L(s,f)$ is a linear combination of primitive $L$-functions.
    \end{remark}
