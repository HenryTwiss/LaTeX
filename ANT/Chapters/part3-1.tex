\chapter{The Theory of \texorpdfstring{$L$}{L}-functions}
  ...
  \section{The Lindel\"of Hypothesis \& Convexity Arguments}
    ...
    \]
    for $s$ in any vertical strip with distance $\e$ away from the poles of $\g(1-s,f)$ and where we have used that $\left(\left|\frac{t+\Im(k_{i})}{2}\right|+1\right) \asymp (|s+k_{i}|+3)$. In particular, setting $\s = -\e$, our previous two bounds combine to give
    \[
