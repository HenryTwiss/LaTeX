\chapter{The Theory of \texorpdfstring{$L$}{L}-functions}
  ...
  \section{The Riemann Hypothesis \& Nontrivial Zeros}
    ...
    The Selberg class \textbf{Riemann hypothesis}\index{Riemann hypothesis} says that this symmetry should be as simple as possible:
  ...
  \section{The Lindel\"of Hypothesis \& Convexity Arguments}
    ...
    \end{equation}
    The Selberg class \textbf{Lindel\"of hypothesis}\index{Lindel\"of hypothesis} says that the exponent can be reduced to $\e$:
  ...
  \section{Zero Density}
    ...
    \begin{lemma}\label{lem:powerful_L-function_approximation_lemma}
      ...
      \begin{enumerate}[label=(\roman*)]
        ...
        \item For any $T > 0$, the number of nontrivial zeros $\rho = \b+i\g$ with $\rho \neq 0,1$ and such that $|T-\g| \le 1$ is $O(\log{\mathfrak{q}(iT,f)})$.
        \item We have
        \[
