  ...
  \section{\todo{Zero Density}}
    ...
    \begin{proof}
      ...
      \begin{equation}\label{equ:zero_counting_2}
       \D_{\eta_{L}}\arg{q(f)^{\frac{s}{2}}} = \Im(\log{q(f)^{\frac{s}{2}}})\bigg|_{\frac{1}{2}-i\d}^{\frac{1}{2}+iT} = \log{q(f)}\left(\frac{T}{2}+\frac{\d}{2}\right) = O(T\log{q(f)}).
      \end{equation}
      For the factor $\pi^{-\frac{d_{f}s}{2}}$, we compute
      \begin{equation}\label{equ:zero_counting_3}
       \D_{\eta_{L}}\arg(\pi^{-\frac{d_{f}s}{2}}) = \Im(\log(\pi^{-\frac{d_{f}s}{2}}))\bigg|_{\frac{1}{2}-i\d}^{\frac{1}{2}+iT} = \log\left(\frac{1}{\pi^{d_{f}}}\right)\left(\frac{T}{2}+\frac{\d}{2}\right) = O\left(T\log\left(\frac{1}{\pi^{d_{f}}}\right)\right).
      \end{equation}
      \todo{xxx}
    \end{proof}
