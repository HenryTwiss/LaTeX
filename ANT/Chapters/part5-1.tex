\chapter{Moments of \texorpdfstring{$L$}{L}-functions}
  ...
  \section{\todo{Moments of \texorpdfstring{$L$}{L}-functions}}
    ...
    \begin{proof}
      ...
      \]
      as desired. Now suppose the Lindel\"of hypothesis for $L(s,f)$ is false. Then there is some $\l > 0$ and positive unbounded real sequence $(t_{n})_{n \ge 1}$ such that
      \[
