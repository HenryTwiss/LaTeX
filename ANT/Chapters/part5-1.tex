\chapter{Moments of \texorpdfstring{$L$}{L}-functions}
  ...
  \section{\todo{The Katz-Sarnak Philosophy}}
    ...
    \subsection*{The Work of Montgomery \& Dyson}
      ...
      We interpret \cref{prop:unfolded_zeros_are_evenly_spaced} as saying that the unfolded nontrivial zeros are evenly spaced opposed to \cref{cor:zero_density} which says that they tend to accumulate up the critical strip. The purpose of unfolding the nontrivial zeros is to dispense with this clustering.
      
      \iffalse
      For the following discussion of Montgomery and Dyson's work, let us consider the Riemann zeta function only. We consider the \textbf{two-point correlation function}\index{two-point correlation function}
      \[
