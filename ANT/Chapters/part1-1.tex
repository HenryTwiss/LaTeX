  \chapter{Preliminaries}\label{ch:Preliminaries}
    ...
    \section{Asymptotic Notation}
      ...
      \begin{remark}
        Suppose $f,g:\Z_{\ge 0} \to \C$. Extending $f$ and $g$ by making them piecewise linear so that $f,g:\R_{\ge 0} \to \C$ is piecewise continuous, we can consider estimates with $n$ in place of $z$. All of the following theory still holds. Moreover, if we further take $f$ or $g$ to be a constant function, the following theory will still hold.
      \end{remark}
