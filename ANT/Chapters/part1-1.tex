\chapter{Preliminaries}\label{ch:Preliminaries}
  ...
  \section{Notational Conventions}
    ...
    \begin{itemize}
      ...
      \[
        \a\mathbf{z} = (\a z_{1},\ldots,\a z_{n}), \quad \mathbf{z}^{\a} = (z_{1}^{\a},\ldots,z_{n}^{\a}), \quad \mathbf{z}^{\mathbf{w}} = z_{1}^{w_{1}} \cdots z_{n}^{w_{n}}, \quad \text{and} \quad \mathbf{z}\mathbf{w} = (z_{1}w_{1},\ldots,z_{n}w_{n}),
      \]
      for all $\a \in \C$ and $\mathbf{w} = (w_{1},\ldots,w_{n}) \in \C^{n}$ respectively.
