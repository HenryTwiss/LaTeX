\chapter{Preliminaries}\label{ch:Preliminaries}
  ...
  \section{Notational Conventions}
    ...
    \begin{itemize}
      ...
      \[
        \frac{\a}{\b}\mathbf{z} = \left(\frac{\a}{\b}z_{1},\ldots,\frac{\a}{\b}z_{n}\right), \quad \mathbf{z}^{\a} = (z_{1}^{\a},\ldots,z_{n}^{\a}), \quad \mathbf{z}^{\mathbf{w}} = z_{1}^{w_{1}} \cdots z_{n}^{w_{n}}, \quad \text{and} \quad \mathbf{z}\mathbf{w} = (z_{1}w_{1},\ldots,z_{n}w_{n}),
      \]
      for all $\a,\b \in \C$ with $\b$ nonzero and $\mathbf{w} = (w_{1},\ldots,w_{n}) \in \C^{n}$ respectively.
