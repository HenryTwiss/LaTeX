\chapter{Trace Formulas}
  ...
  \section{The Kuznetsov Trace Formula}
    ...
    \]
    By \cref{equ:Dirac_integral_representation}, the inner integral cuts off the first two terms in the integrand and every term in the sum except the diagonal term $t = m$. Therefore
    \[
    ...
    \]
    Moreover, $\<P_{n,\chi}(\cdot,\psi),u_{0}\> = 0$. Putting everything together, we arrive at
    \begin{align*}
