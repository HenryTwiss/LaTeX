\chapter{Trace Formulas}
  ...
  \section{\todo{The Petersson Trace Formula}}
    ...
    \begin{theorem}
      ...
      \[
        P_{m,\chi}(z) = \sum_{n \ge 0}a(n)e^{2\pi inz},
      \]
      where
      \[
        a(n) = \left(\d_{m,n}+\left(\frac{\sqrt{n}}{\sqrt{m}}\right)^{k-1}\sum_{\substack{c \ge 1 \\ c \equiv 0 \tmod{N}}}\frac{2\pi i^{-k}}{c}J_{k-1}\left(\frac{4\pi\sqrt{mn}}{c}\right)S_{\chi}(m,n,c)\right)e^{2\pi inz}.
      \]
    \end{theorem}
    \begin{proof}
