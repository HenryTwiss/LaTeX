\chapter{The Theory of Maass Forms}
  ...
  \section{Maass Forms}
    ...
    \]
    for some different Fourier coefficients $a_{\mf{a}}(n,s)$ (they are $\sqrt{4|n|}$ multiples). From now on, if we are talking about weight zero Maass forms we will always mean this latter Fourier series.
  ...
  \section{Diamond \& Hecke Operators}
    ...
    \begin{proposition}\label{prop:parity_operator_Fourier_series}
      ...
      \begin{align*}
        ...
        &+\sum_{n \ge 1}a_{-n}(f)\d(\nu,k)W_{\frac{k}{2},\nu}(4\pi |n|y)e^{2\pi inx}+\sum_{n \ge 1}a_{n}(f)\d(\nu,k)^{-1}W_{-\frac{k}{2},\nu}(4\pi |n|y)e^{-2\pi inx},
      \end{align*}
