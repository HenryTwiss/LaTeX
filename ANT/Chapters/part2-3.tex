\chapter{The Theory of Maass Forms}
  ...
  \section{Twists of Maass Forms}
    ...
    \]
    and let $\psi$ be a Dirichlet character modulo $M$. We define the \textbf{twisted Maass form}\index{twisted Maass form} $f \ox \psi$ of $f$ twisted by $\psi$ by the Fourier series
    \[
