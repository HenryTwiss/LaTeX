\chapter{The Theory of Maass Forms}
  ...
  \section{Maass Forms}
    ...
    \]
    In particular, $f$ exhibits exponential decay to zero near the cusps and so is bounded on $\H$. From now on, we will always assume that our congruence subgroups are reduced at infinity so that $t = 1$.
