\chapter{The Theory of Automorphic \& Maass Forms}
  ...
  \section{Atkin-Lehner Theory}
    ...
    \begin{proposition}\label{prop:old/new_subspaces_are_invariant_Maass}
      On $\mc{C}_{k,\nu}(\G_{1}(N))$, the diamond operators $\<m\>$ and Hecke operators $T_{m}$ preserve the subspaces of oldforms and newforms for all $m \ge 1$ as well as the parity Hecke operator $T_{-1}$.
    \end{proposition}
