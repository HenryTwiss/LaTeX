\chapter{The Theory of Maass Forms}
  ...
  \section{Diamond \& Hecke Operators}
    ...
    \begin{proposition}\label{prop:prime_Hecke_operators_acting_on_Fourier_coefficients_Maass}
      ...
      \begin{align*}
        (T_{p}f)(z) = (a_{0}(f)+\chi_{N,0}(p)a_{0}(\<p\>f))y^{s}&+(b_{0}(f)+\chi_{N,0}(p)b_{0}(\<p\>f))y^{1-s} \\
        &+ \sum_{n \ge 1}\left(a_{np}(f)+\chi_{N,0}(p)a_{\frac{n}{p}}(\<p\>f)\right)\sqrt{y}K_{it}(2\pi ny)\SC(2\pi nx),
      \end{align*}
      ...
      \begin{align*}
        (T_{p}f)(z) = (a_{0}(f)+\chi(p)a_{0}(f))y^{s}&+(b_{0}(f)+\chi(p)b_{0}(f))y^{1-s} \\
        &+ \sum_{n \ge 1}\left(a_{np}(f)+\chi(p)a_{\frac{n}{p}}(f)\right)\sqrt{y}K_{it}(2\pi ny)\SC(2\pi nx),
      \end{align*}
    ...
    \begin{proposition}\label{prop:general_Hecke_operators_acting_on_Fourier_coefficients_Maass}
      ...
      \begin{align*}
        (T_{m}f)(z) = \left(\sum_{d \mid m}a_{0}(\<d\>f)\right)y^{s}&+\left(\sum_{d \mid m}b_{0}(\<d\>f)\right)y^{1-s} \\
        &+ \sum_{n \ge 1}\left(\sum_{d \mid (n,m)}a_{\frac{nm}{d^{2}}}(\<d\>f)\right)\sqrt{y}K_{it}(2\pi ny)\SC(2\pi inx),
      \end{align*}
      is the Fourier series of $T_{m}f$. Moreover, if $f \in \mc{A}_{t}(N,\chi)$, then
      \begin{align*}
        (T_{m}f)(z) = \left(\sum_{d \mid m}\chi(d)a_{0}(f)\right)y^{s}&+\left(\sum_{d \mid m}\chi(d)b_{0}(f)\right)y^{1-s} \\
        &+ \sum_{n \ge 1}\left(\sum_{d \mid (n,m)}\chi(d)a_{\frac{nm}{d^{2}}}(f)\right)\sqrt{y}K_{it}(2\pi ny)\SC(2\pi inx).
      \end{align*}
    \end{proposition}
    \begin{proof}
  ...
  \section{Twists of Maass Forms}
    ...
    \[
      (f \ox \psi)(z) = a(0)\psi(0)y^{s}+b(0)\psi(0)y^{1-s}+\sum_{n \ge 1}a(n)\psi(n)\sqrt{y}K_{it}(2\pi ny)\SC(2\pi nx).
    \]
    ...
    \[
      (U_{p}f)(z) = a(0)y^{s}+b(0)y^{1-s}+\sum_{n \ge 1}a(np)\psi(n)\sqrt{y}K_{it}(2\pi ny)\SC(2\pi nx)
    \]
    and
    \[
      (V_{p}f)(z) = a(0)(py)^{s}+b(0)(py)^{1-s}+\sum_{n \ge 1}a(n)\psi(n)\sqrt{y}K_{it}(2\pi npy)\SC(2\pi npx)
    \]
    if $f$ has Fourier series
    \[
      f(z) = a(0)y^{s}+b(0)y^{1-s}+\sum_{n \ge 1}a(n)\sqrt{y}K_{it}(2\pi ny)\SC(2\pi nx).
    \]
    We will show that both $U_{p}$ and $V_{p}$ send forms on $\G_{1}(N)\backslash\H$ to forms on $\G_{1}(Np)\backslash\H$:

    \begin{lemma}\label{lem:twisted_Maass_lemma}
      For any prime $p$, $U_{p}$ and $V_{p}$ map $\mc{A}_{t}(\G_{1}(N))$ into $\mc{A}_{t}(\G_{1}(Np))$. In particular, $U_{p}$ and $V_{p}$ map $\mc{A}_{t}(N,\chi)$ to $\mc{A}_{t}(Np,\chi\chi_{p,0})$. Moreover, $U_{p}$ and $V_{p}$ preserve the subspace of cusp forms.
    \end{lemma}
    \begin{proof}
      Mimic the proof of \cref{thm:diamond_operator_decomposition_holomorphic}.
    \end{proof}
    ...
    \begin{proof}
      ...
      \]
      shows that $f \ox \psi_{p,0}$ is an eigenfunction with eigenvalue $\l$ if $f$ is.
    \end{proof}