\chapter{The Theory of Maass Forms}
  ...
  \section{Double Coset Operators}
    ...
    \]
    As was the case for holomorphic forms, \cref{prop:double_congruence_subgroup_coset_decomposition_is_finite} implies that this sum is finite. It remains to check that $f[\G_{1}\a\G_{2}]_{k}$ is well-defined. Indeed, if $\b_{j}$ and $\b_{j}'$ belong to the same orbit, then $\b_{j}'\b_{j}^{-1} \in \G_{1}$. But then as $f \in \mc{A}_{k,\nu}(\G_{1})$, is it invariant under the $[\b_{j}'\b_{j}^{-1}]_{k}$ operator so that
    \[
  ...
  \section{Diamond \& Hecke Operators}
    ...
    \begin{proposition}\label{prop:prime_Hecke_operators_acting_on_Fourier_coefficients_Maass}
      ...
      \begin{align*}
        (T_{p}f)(z) = (p^{-\frac{1}{2}-\nu}a_{0}^{+}(f)+\chi_{N,0}(p)p^{\nu-\frac{1}{2}}&a_{0}^{+}(\<p\>f))y^{\frac{1}{2}+\nu}+(p^{\nu-\frac{1}{2}}a_{0}^{-}(f)+\chi_{N,0}(p)p^{-\frac{1}{2}-\nu}a_{0}^{-}(\<p\>f))y^{\frac{1}{2}-\nu} \\
      ...
      \begin{align*}
        (T_{p}f)(z) = (p^{-\frac{1}{2}-\nu}a_{0}^{+}(f)+\chi(p)p^{\nu-\frac{1}{2}}&a_{0}^{+}(f))y^{\frac{1}{2}+\nu}+(p^{\nu-\frac{1}{2}}a_{0}^{-}(f)+\chi(p)p^{-\frac{1}{2}-\nu}a_{0}^{-}(f))y^{\frac{1}{2}-\nu} \\
    ...
    \begin{proposition}\label{prop:general_Hecke_operators_acting_on_Fourier_coefficients_Maass}
      ...
      \begin{align*}
        (T_{m}f)(z) = (m^{-\frac{1}{2}-\nu}a_{0}^{+}(f)+m^{\nu-\frac{1}{2}}a_{0}^{+}(\<m\>f))&y^{\frac{1}{2}+\nu}+(m^{\nu-\frac{1}{2}}a_{0}^{-}(f)+m^{-\frac{1}{2}-\nu}a_{0}^{-}(\<m\>f))y^{\frac{1}{2}-\nu} \\
      ...
      \begin{align*}
        (T_{m}f)(z) = (m^{-\frac{1}{2}-\nu}a_{0}^{+}(f)+\chi(m)m^{\nu-\frac{1}{2}}a_{0}^{+}(f))&y^{\frac{1}{2}+\nu}+(m^{\nu-\frac{1}{2}}a_{0}^{-}(f)+\chi(m)m^{-\frac{1}{2}-\nu}a_{0}^{-}(f))y^{\frac{1}{2}-\nu} \\
  ...
  \section{Atkin–Lehner Theory}
    ...
    \[
      \conj{f}(z) = \conj{f(-z)}.
    \]
    Then we have the following (argue as in the proof for holomorphic forms given in \cite{cohenmodular2017}):
  ...
  \section{Twists of Maass Forms}
    ...
    \end{proposition}
    \begin{proof}
      Arguing as in the proof of \cref{prop:twisted_holomorphic_forms}, it remains to show that $f \ox \psi_{p,0}$ is an eigenfunction with eigenvalue $\l$ if $f$ is. As $U_{p} = T_{p}$ is the $p$-th Hecke operator on $\mc{A}_{k,\nu}(\G_{1}(Np))$, $U_{p}$ commutes with $\D$. It is also clear that $V_{p}$ commutes with $\D$. These facts together with
      \[
