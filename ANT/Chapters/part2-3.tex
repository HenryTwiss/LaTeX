  ...
  \section{\texorpdfstring{$L^{2}$}{L{2}}-integrable Automorphic Functions}
    ...
    \begin{proof}
      ...
      \begin{align*}
        ...
        &= \frac{1}{V_{\G}}\int_{\mc{F}_{\a^{-1}\G\a}}f(\a z)\conj{g(\a z)}\,d\mu && \text{$\conj{\e(\a,z)} = \e(\a,z)^{-1}$} \\
    ...
    \begin{align*}
      ...
      &= \frac{1}{V_{\G}}\int_{\mc{F}_{\G}}\sum_{\g \in \G_{\a}\backslash\G}\chi(\g)\e(\s_{\mf{a}}^{-1}\g,z)^{k}f(z)\conj{\psi(\Im(\s_{\mf{a}}^{-1}\g z))}\,d\mu && \text{$\conj{\e(\s_{\mf{a}}^{-1}\g,z)} = \e(\s_{\mf{a}}^{-1}\g,z)^{-1}$} \\
