\chapter{The Theory of Maass Forms}
  ...
  \section{Twists of Maass Forms}
    ...
    \]
    and let $\psi$ be a primitive Dirichlet character of conductor $M$. We define the \textbf{twisted Maass form}\index{twisted Maass form} $f \ox \psi$ of $f$ twisted by $\psi$ by the Fourier series
    \[
    ...
    \begin{proposition}\label{prop:twisted_Maass_forms}
      Suppose $f \in \mc{A}_{t}(N,\chi)$ and $\psi$ is a primitive Dirichlet character of conductor $M$. Then $f \ox \psi \in \mc{A}_{t}(NM^{2},\chi\psi^{2})$. Moreover, if $f$ is a cusp form then so is $f \ox \psi$.
    \end{proposition}
    \begin{proof}
