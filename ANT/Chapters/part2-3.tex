\chapter{The Theory of Automorphic \& Maass Forms}
  ...
  \section{Automorphic \& Maass Forms}
    ...
    \]
    This implies $(f|_{k}\s_{\mf{a}})(z)$ exhibits decay although it is not necessarily rapid. Accordingly, we say that $f$ exhibits \textbf{moderate decay at the cusps}\index{moderate decay at the cusps}. Observe that $f|_{k}\s_{\mf{a}}$ is then bounded on $\H$ and, in particular, $f$ is bounded on $\H$.
