\chapter{Classical Applications}
  ...
  \section{Siegel's Theorem}
    ...
    \end{proof}
  \section{Estimates for the Class Number of Quadratic Number Fields}
    ...
    \begin{theorem}\label{thm:Value_of_Dirichlet_L-functions_at_s=1}
      ...
      \[
        L(1,\chi) = -\frac{\tau(\chi)}{q}\sum_{a \tmod{q}}\cchi(a)\log\sin\left(\frac{\pi a}{q}\right) \quad \text{or} \quad L(1,\chi) = \frac{\tau(\chi)\pi i}{q^{2}}\sum_{a \tmod{q}}\cchi(a)a,
      \]
    ...
    \begin{corollary}\label{cor:formula_for_class_number_quadratic_number_field}
      ...
      \[
        h_{d} = \frac{\sqrt{|\D_{d}|}}{2\log|\e_{d}|}\left(-\frac{\tau(\chi)}{|\D_{d}|}\sum_{a \tmod{|\D_{d}|}}\cchi(a)\log\sin\left(\frac{\pi a}{|\D_{d}|}\right)\right) \quad \text{or} \quad h_{d} = \frac{w_{d}\sqrt{|\D_{d}|}}{2\pi}\left(\frac{\tau(\chi)\pi i}{|\D_{d}|^{2}}\sum_{a \tmod{|\D_{d}|}}\cchi(a)a\right),
      \]
