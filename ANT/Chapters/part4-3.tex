...
\section{Strong Multiplicity One \& the Ramanujan-Petersson Conjecture on Average}
  We will discuss two applications of the Rankin-Selberg method for Hecke and Hecke-Maass eigenforms: strong multiplicity one and the Ramanujan-Petersson conjecture on average. For the former, recall that multiplicity one determines and eigenform, up to a constant, by its Hecke eigenvalues at primes. Using Rankin-Selberg convolutions, we can prove \textbf{strong multiplicity one}\index{strong multiplicity one} for holomorphic or Maass forms which says that eigenforms are determined by their Hecke eigenvalues at all but finitely many primes:
  ...
  Now we discuss how to obtain the Ramanujan-Petersson conjecture on average using Rankin-Selberg convolutions without assuming the corresponding Ramanujan-Petersson conjecture:
