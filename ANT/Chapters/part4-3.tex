\chapter{Applications of \texorpdfstring{$L$}{L}-functions}
  ...
  \section{Dirichlet's Theorem on Arithmetic Progressions}
    ...
    \end{proof}
  \section{Siegel's Theorem \& Siegel Zeros}
  ...
  \section{The Prime Number Theorem}
    ...
    \]
    which is simply the logarithmic integral version of the prime number theorem. Legendre was the first to put forth a conjectural form of the prime number theorem. In 1798 (see \cite{legendre1798essai}) he claimed that $\pi(x)$ was of the form
    \[
      \frac{x}{A\log(x)+B},
    \]
