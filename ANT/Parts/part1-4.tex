  ...
  \section{The Gamma Function}
    ...
    \begin{proof}
      ...
      \[
        \G(s) = \sqrt{2\pi}s^{s-\frac{1}{2}}e^{-s}\left(1+O\left(\frac{1}{s}\right)\right).
      \]
      This proves the claim in the case $\s > 0$. In fact, applying \cref{prop:Factorial_properties_of_gamma_function} (ii) repeatedly shows
      \[
      ...
      \]
      As $n$ was arbitrary, this proves the claim for $\s \le 0$ as well which completes the proof.
    \end{proof}
