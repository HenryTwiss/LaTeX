\chapter{Analytic Preliminaries}
  ...
  \section{The Gamma Function}
    ...
    Note that \cref{equ:weaker_Stirling_formula} only tells us how $\G(s)$ grows for large $t$ when $\s$ is bounded. Regardless, Stirling's formula also implies the asymptotic
