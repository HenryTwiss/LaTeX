\chapter{Prime Number Theorems}
  One of the most infamous applications of $L$-functions, and gems of analytic number theory, is the prime number theorem which provides an asymptotic for the density of the prime numbers up to a certain size in terms of elementary functions. We prove the prime number theorem and its variant for primes restricted to a certain residue class, the Siegel–Walfisz theorem, in the classical manner using the Riemann zeta function and Dirichlet $L$-functions respectively.
