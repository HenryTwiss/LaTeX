\chapter{Moment Results}
  ...
  \section{The Second Moment of the Riemann Zeta Function}
    ...
    \]
    The aforementioned result of Hardy and Littlewood (see \cite{hardy1916contributions}) is an asymptotic equivalence for $M_{2}(T,\z)$. Actually, we prove something slightly stronger:
