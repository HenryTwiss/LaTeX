\chapter{Moment Results}
  ...
  \section{\todo{The Second Moment of the Riemann Zeta Function}}
    ...
    \begin{proof}
      ...
      \]
      By \cref{prop:V_function_decay}, we find that $V_{\frac{1}{2}+it}\left(\frac{n}{\sqrt{t}}\right)$ and $V_{\frac{1}{2}-it}(n\sqrt{t})$ are bounded for $n \ll_{\e} t^{1+\e}$ and $n \ll_{\e} t^{\e}$ respectively and then starts to exhibit polynomial decay of arbitrarily large order \todo{xxx}
    \end{proof}