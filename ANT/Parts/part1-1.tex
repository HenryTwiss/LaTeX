\chapter{Preliminaries}\label{ch:Preliminaries}
  ...
  \section{Arithmetic Functions}
    ...
    A certain case of interest for Dirichlet convolution is when the M\"obius function is convolved with the constant function:
      ...
      In particular,
      \[
        \mu \ast \mathbf{1} = \d = \mathbf{1} \ast \mu.
      \]
      \end{proposition}
      \begin{proof}
      ...
      \end{theorem*}
      \begin{proof}
        In terms of Dirichlet convolutions, it is equivalent to show that
        \[
          g = f \ast \mathbf{1},
        \]
        if and only if
        ...
        \]
        with the last two equalities following from \cref{prop:Mobius_indicator} and that $\d$ is the identity for Dirichlet convolution.
      \end{proof}
    ...
    \subsection*{The Divisor, Sum of Divisors, and Generalized Sum of Divisors Functions}
