\chapter{The Theory of Automorphic and Maass Forms}
  ...
  \section{Poincar\'e and Eisenstein Series}
    ...
    \begin{proposition}\label{prop:Fourier_series_Poincare_automorphic}
      Let $m \ge 1$, $k \ge 0$, $\chi$ be Dirichlet character with conductor dividing the level, and $\mf{a}$ and $\mf{b}$ be cusps of $\GH$. The Fourier series of $P_{m,k,\chi,\mf{a}}(z,s)$ on $\GH$ at the $\mf{b}$ cusp is given by
      \[
    ...
    \begin{proposition}\label{prop:Fourier_Whittaker_series_Eisenstein_Maass}
      Let $k \ge 0$, $\chi$ be Dirichlet character with conductor dividing the level, and $\mf{a}$ and $\mf{b}$ be cusps of $\GH$. The Fourier series of $E_{k,\chi,\mf{a}}(z,s)$ on $\GH$ at the $\mf{b}$ cusp is given by
      \[
