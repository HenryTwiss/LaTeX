\chapter{The Theory of Automorphic and Maass Forms}
  ...
  \section{Poincar\'e and Eisenstein Series}
    ...
    \begin{proposition}\label{prop:Fourier_series_Poincare_automorphic}
      ...
      \[
        (P_{m,k,\chi,\mf{a}}|\s_{\mf{b}})(z,s) = \sum_{t \in \Z}\left(\d_{\mf{a},\mf{b}}\d_{m,t}y^{s}e^{-2\pi my}+y^{1-s}\sum_{\substack{c \in \mc{C}_{\mf{a},\mf{b}}}}\frac{i^{-k}S_{\chi,\mf{a},\mf{b}}(m,t,c)}{c^{2s}}A(y,s,m,t,c)\right)e^{2\pi itx},
      \]
    ...
    \begin{proof}
     ...
     where on the right-hand side it is understood that we are summing over all triples $(c,\ell,r)$ with the prescribed properties and the second line holds since $\chi$ has conductor diving the level and $d \in \mc{D}_{\mf{a},\mf{b}}(c)$ is determined modulo $c$. Now let
      ...
      \[
        \frac{y^{1-2s}}{c^{2s}}e^{2\pi im\frac{a}{c}+2\pi it\frac{r}{c}}\int_{-\infty}^{\infty}\frac{e^{-2\pi im\left(\frac{1}{c^{2}y(x+i)}\right)}}{(x+i)^{s+\frac{k}{2}}(x-i)^{s-\frac{k}{2}}}e^{-2\pi itxy}\,dx,
      \]
      which we can further rewrite as
      \[
        y^{1-2s}\frac{i^{-k}}{c^{2s}}e^{2\pi im\frac{a}{c}+2\pi it\frac{r}{c}}\int_{-\infty}^{\infty}\frac{e^{-2\pi im\left(\frac{1}{c^{2}y(x+i)}\right)}}{(1-ix)^{s+\frac{k}{2}}(1+ix)^{s-\frac{k}{2}}}e^{-2\pi itxy}\,dx.
      \]
      So in total we obtain
      \[
        (\mc{F}f)(t) = y^{1-2s}\frac{i^{-k}}{c^{2s}}A(y,s,m,t,c)e^{2\pi im\frac{a}{c}+2\pi it\frac{r}{c}}.
      \]
      By the Poisson summation formula and the identity theorem, we have
      \[
        I_{c,r}(z,s) = \sum_{t \in \Z}\left(y^{1-2s}\frac{i^{-k}}{c^{2s}}A(y,s,m,t,c)e^{2\pi im\frac{a}{c}+2\pi it\frac{r}{c}}\right)e^{2\pi itx}.
      \]
      Plugging this back into the Poincar\'e series gives a form of the Fourier series:
      \begin{align*}
        (P_{m,k,\chi,\mf{a}}|\s_{\mf{b}})(z,s) &= \d_{\mf{a},\mf{b}}y^{s}e^{2\pi imz}+\sum_{\substack{c \in \mc{C}_{\mf{a},\mf{b}} \\ r \in \mc{D}_{\mf{a},\mf{b}}}}\cchi(r)y^{s}\sum_{t \in \Z}\left(y^{1-2s}\frac{i^{-k}}{c^{2s}}A(y,s,m,t,c)e^{2\pi im\frac{a}{c}+2\pi it\frac{r}{c}}\right)e^{2\pi itx} \\
        &= \sum_{t \in \Z}\left(\d_{\mf{a},\mf{b}}\d_{m,t}y^{s}e^{-2\pi my}+y^{1-s}\sum_{\substack{c \in \mc{C}_{\mf{a},\mf{b}} \\ r \in \mc{D}_{\mf{a},\mf{b}}}}\cchi(r)\frac{i^{-k}}{c^{2s}}A(y,s,m,t,c)e^{2\pi im\frac{a}{c}+2\pi it\frac{r}{c}}\right)e^{2\pi itx} \\
        &= \sum_{t \in \Z}\left(\d_{\mf{a},\mf{b}}\d_{m,t}y^{s}e^{-2\pi my}+y^{1-s}\sum_{\substack{c \in \mc{C}_{\mf{a},\mf{b}}}}\frac{i^{-k}}{c^{2s}}A(y,s,m,t,c)\sum_{r \in \mc{D}_{\mf{a},\mf{b}}}\cchi(r)e^{2\pi im\frac{a}{c}+2\pi it\frac{r}{c}}\right)e^{2\pi itx}.
      \end{align*}
    ...
    \begin{proposition}\label{prop:Fourier_series_Eisenstein_Maass}
      ...
      \begin{align*}
        (E_{k,\chi,\mf{a}}|\s_{\mf{b}})(z,s) &= \d_{\mf{a},\mf{{b}}}y^{s}+\frac{\G(2s-1)}{\G\left(s+\frac{k}{2}\right)\G\left(s-\frac{k}{2}\right)}\left(\sum_{c \in \mc{C}_{\mf{a},\mf{b}}}\frac{4\pi i^{-k}S_{\chi,\mf{a},\mf{b}}(0,0,c)}{(2c)^{2s}}\right)y^{1-s} \\
        &+ \sum_{t \neq 0}\frac{|t|^{s-1}}{\G\left(s+\sgn(t)\frac{k}{2}\right)}\left(\sum_{c \in \mc{C}_{\mf{a},\mf{b}}}\frac{\pi^{s}i^{-k}S_{\chi,\mf{a},\mf{b}}(0,t,c)}{c^{2s}}\right)W_{\sgn(t)\frac{k}{2},\frac{1}{2}-s}(4\pi|t|y)e^{2\pi itx}.
    \end{align*}
    \end{proposition}
    \begin{proof}
      From the cocycle condition, the Bruhat decomposition for $\s_{\mf{a}}^{-1}\G\s_{\mf{b}}$, and \cref{rem:Bruhat_modulo_infity_exact}, we have
     ...
     where on the right-hand side it is understood that we are summing over all triples $(c,\ell,r)$ with the prescribed properties and the second line holds since $\chi$ has conductor diving the level and $d \in \mc{D}_{\mf{a},\mf{b}}(c)$ is determined modulo $c$. Now let
      ...
      \[
        \frac{y^{1-2s}}{c^{2s}}e^{2\pi it\frac{r}{c}}\int_{-\infty}^{\infty}\frac{e^{-2\pi itxy}}{(x+i)^{s+\frac{k}{2}}(x-i)^{s-\frac{k}{2}}}\,dx,
      \]
      which we can further rewrite as
      \[
        y^{1-2s}\frac{i^{-k}}{c^{2s}}e^{2\pi it\frac{r}{c}}\int_{-\infty}^{\infty}\frac{e^{-2\pi itxy}}{(1-ix)^{s+\frac{k}{2}}(1+ix)^{s-\frac{k}{2}}}\,dx.
      \]
      Appealing to \cref{append:Special_Integrals}, we recognize this last integral as
      \[
        \int_{-\infty}^{\infty}\frac{e^{-2\pi itxy}}{(1-ix)^{s+\frac{k}{2}}(1+ix)^{s-\frac{k}{2}}}\,dx = \begin{cases} \frac{\pi}{2^{2s-2}}\frac{\G(2s-1)}{\G\left(s+\frac{k}{2}\right)\G\left(s-\frac{k}{2}\right)} & \text{if $t = 0$,} \\ \frac{\pi(\pi|t|y)^{s-1}}{\G\left(s+\sgn(t)\frac{k}{2}\right)}W_{\sgn(t)\frac{k}{2},\frac{1}{2}-s}(4\pi|t|y) & \text{if $t \neq 0$.} \end{cases}.
      \]
      So in total we obtain
      \[
        (\mc{F}f)(t) = \begin{cases} y^{1-2s}\frac{4\pi i^{-k}}{(2c)^{2s}}\frac{\G(2s-1)}{\G\left(s+\frac{k}{2}\right)\G\left(s-\frac{k}{2}\right)} & \text{if $t = 0$,} \\ y^{-s}\frac{\pi^{s}i^{-k}}{c^{2s}}\frac{|t|^{s-1}}{\G\left(s+\sgn(t)\frac{k}{2}\right)}W_{\sgn(t)\frac{k}{2},\frac{1}{2}-s}(4\pi|t|y)e^{2\pi it\frac{r}{c}} & \text{if $t \neq 0$.} \end{cases}
      \]
      By the Poisson summation formula and the identity theorem, we have
      \begin{align*}
        I_{c,r}(z,s) &= y^{1-2s}\frac{4\pi i^{-k}}{(2c)^{2s}}\frac{\G(2s-1)}{\G\left(s+\frac{k}{2}\right)\G\left(s-\frac{k}{2}\right)} \\
        &+ \sum_{t \neq 0}\left(y^{-s}\frac{\pi^{s}i^{-k}}{c^{2s}}\frac{|t|^{s-1}}{\G\left(s+\sgn(t)\frac{k}{2}\right)}W_{\sgn(t)\frac{k}{2},\frac{1}{2}-s}(4\pi|t|y)e^{2\pi it\frac{r}{c}}\right)e^{2\pi itx}.
      \end{align*}
      Plugging this back into the Eisenstein series gives a form of the Fourier-Whittaker series:
    \begin{align*}
      (E_{k,\chi,\mf{a}}|\s_{\mf{b}})(z,s) &= \d_{\mf{a},\mf{{b}}}y^{s}+y^{s}\sum_{\substack{c \in \mc{C}_{\mf{a},\mf{b}} \\ r \in \mc{D}_{\mf{a},\mf{b}}(c)}}\cchi(r)y^{1-2s}\frac{4\pi i^{-k}}{(2c)^{2s}}\frac{\G(2s-1)}{\G\left(s+\frac{k}{2}\right)\G\left(s-\frac{k}{2}\right)} \\
      &+y^{s}\sum_{\substack{c \in \mc{C}_{\mf{a},\mf{b}} \\ r \in \mc{D}_{\mf{a},\mf{b}}(c)}}\cchi(r)\sum_{t \neq 0}\left(y^{-s}\frac{\pi^{s}i^{-k}}{c^{2s}}\frac{|t|^{s-1}}{\G\left(s+\sgn(t)\frac{k}{2}\right)}W_{\sgn(t)\frac{k}{2},\frac{1}{2}-s}(4\pi|t|y)e^{2\pi it\frac{r}{c}}\right)e^{2\pi itx} \\
      &= \d_{\mf{a},\mf{{b}}}y^{s}+\frac{\G(2s-1)}{\G\left(s+\frac{k}{2}\right)\G\left(s-\frac{k}{2}\right)}\left(\sum_{\substack{c \in \mc{C}_{\mf{a},\mf{b}} \\ r \in \mc{D}_{\mf{a},\mf{b}}(c)}}\cchi(r)\frac{4\pi i^{-k}}{(2c)^{2s}}\right)y^{1-s} \\
      &+ \sum_{t \neq 0}\left(\sum_{\substack{c \in \mc{C}_{\mf{a},\mf{b}} \\ r \in \mc{D}_{\mf{a},\mf{b}}(c)}}\cchi(r)\frac{\pi^{s}i^{-k}}{c^{2s}}\frac{|t|^{s-1}}{\G\left(s+\sgn(t)\frac{k}{2}\right)}e^{2\pi it\frac{r}{c}}\right)W_{\sgn(t)\frac{k}{2},\frac{1}{2}-s}(4\pi|t|y)e^{2\pi itx} \\
      &= \d_{\mf{a},\mf{{b}}}y^{s}+\frac{\G(2s-1)}{\G\left(s+\frac{k}{2}\right)\G\left(s-\frac{k}{2}\right)}\left(\sum_{c \in \mc{C}_{\mf{a},\mf{b}}}\frac{4\pi i^{-k}}{(2c)^{2s}}\sum_{r \in \mc{D}_{\mf{a},\mf{b}}(c)}\cchi(r)\right)y^{1-s} \\
      &+ \sum_{t \neq 0}\frac{|t|^{s-1}}{\G\left(s+\sgn(t)\frac{k}{2}\right)}\left(\sum_{c \in \mc{C}_{\mf{a},\mf{b}}}\frac{\pi^{s}i^{-k}}{c^{2s}}\sum_{r \in \mc{D}_{\mf{a},\mf{b}}(c)}\cchi(r)e^{2\pi it\frac{r}{c}}\right)W_{\sgn(t)\frac{k}{2},\frac{1}{2}-s}(4\pi|t|y)e^{2\pi itx}.
    \end{align*}
    ...
    \[
      \sum_{r \in \mc{D}_{\mf{a},\mf{b}}}\cchi(r)e^{2\pi it\frac{r}{c}} = \sum_{r \in \mc{D}_{\mf{a},\mf{b}}}\cchi(\conj{a})e^{2\pi it\frac{\conj{a}}{c}} = \sum_{r \in \mc{D}_{\mf{a},\mf{b}}}\chi(a)e^{\frac{2\pi i(am+\conj{a}t)}{c}} = S_{\chi,\mf{a},\mf{b}}(0,t,c).
    \]
    Similarly, we have
    \[
      \sum_{r \in \mc{D}_{\mf{a},\mf{b}}}\cchi(r) = \sum_{r \in \mc{D}_{\mf{a},\mf{b}}}\cchi(\conj{a}) = \sum_{r \in \mc{D}_{\mf{a},\mf{b}}}\chi(a) = S_{\chi,\mf{a},\mf{b}}(0,0,c),
    \]
