\chapter{Trace Formulas}
  ...
  \section{The Petersson Trace Formula}
    ...
    \[
      \<P_{n,k,\chi,\mf{a}},P_{m,k,\chi,\mf{b}}\> = \frac{\G(k-1)}{V_{\G_{0}(N)}(4\pi m)^{k-1}}\left(\d_{\mf{a},\mf{b}}\d_{n,m}+2\pi i^{-k}\left(\frac{\sqrt{m}}{\sqrt{n}}\right)^{k-1}\sum_{c \in \mc{C}_{\mf{a},\mf{b}}}\frac{S_{\chi,\mf{a},\mf{b}}(n,m,c)}{c}J_{k-1}\left(\frac{4\pi\sqrt{nm}}{c}\right)\right).
    \]
    ...
    \[
      \frac{\G(k-1)}{V_{\G_{0}(N)}(4\pi n)^{k-1}}\sum_{1 \le j \le r}\frac{\conj{a_{j,\mf{a}}(n)}a_{j,\mf{b}}(m)}{\<u_{j},u_{j}\>} = \d_{\mf{a},\mf{b}}\d_{n,m}+2\pi i^{-k}\left(\frac{\sqrt{m}}{\sqrt{n}}\right)^{k-1}\sum_{c \in \mc{C}_{\mf{a},\mf{b}}}\frac{S_{\chi,\mf{a},\mf{b}}(n,m,c)}{c}J_{k-1}\left(\frac{4\pi\sqrt{nm}}{c}\right).
    \]
    ...
    \[
      \frac{\G(k-1)}{V_{\G_{0}(N)}(4\pi \sqrt{nm})^{k-1}}\sum_{1 \le j \le r}\frac{\conj{a_{j,\mf{a}}(n)}a_{j,\mf{b}}(m)}{\<u_{j},u_{j}\>} = \d_{\mf{a},\mf{b}}\d_{n,m}+2\pi i^{-k}\sum_{c \in \mc{C}_{\mf{a},\mf{b}}}\frac{S_{\chi,\mf{a},\mf{b}}(n,m,c)}{c}J_{k-1}\left(\frac{4\pi\sqrt{nm}}{c}\right).
    \]
