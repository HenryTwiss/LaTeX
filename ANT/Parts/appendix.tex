...
\chapter{Analysis}
  ...
  \section{Interchange of Integrals, Sums \& Derivatives}
    ...
    More commonly, we would like to interchange two sums, two integrals, or a sum and an integral assuming that one expression is absolutely converges. This is sufficient as given by the \textbf{Fubini–Tonelli theorem}\index{Fubini–Tonelli theorem} (FTT):
...
\chapter{Algebra}
  \section{Finitely Generated Modules Over Principal Ideal Domains}
    ...
    \begin{theorem*}[Structure theorem for finitely generated modules over principal ideal domains]
      ...
      \[
        M \cong R^{n} \oplus R/d_{1}M \oplus \cdots \oplus R/d_{t}R,
      \]
    ...
    \begin{theorem*}[Structure theorem for finitely generated abelian groups]
      ...
      \[
        M \cong \Z^{n} \oplus \Z/k_{1}\Z \oplus \cdots \oplus \Z/k_{t}\Z,
      \]
