...
\chapter{Topology}
  \section{Fundamental Domains}\label{append:Fundamental_Domains}
    ...
    \begin{proposition}\label{prop:quotient_by_discrete_property_discontinuously}
      Let $G$ be a group acting on a a connected Hausdorff space $X$ by automorphisms. If $G$ is discrete and acts properly discontinuously then $X/G$ is also a connected Hausdorff space.
    \end{proposition}
