\chapter{Arithmetic Preliminaries}
  We introduce the basic arithmetic functions, the process of forming the Dirichlet convolution of two arithmetic functions, the M\"obius Inversion Formula, specially multiplicative functions, asymptotics of multiplicative functions, and Dirichlet characters.
