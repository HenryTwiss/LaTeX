\chapter{\texorpdfstring{$L$}{L}-functions of Arithmetic Functions}
  ...
  \section{Dirichlet \texorpdfstring{$L$}{L}-functions}
    ...
    \subsection*{Beyond Primitivity}
      ...
      \begin{equation}\label{equ:non-primitive_Dirichlet_series_Euler_product}
      ...
      \end{equation}
      We collect this discussion in the following theorem:
      ...
      \end{theorem}
      \begin{proof}
        This follows from \cref{thm:zeta_Selberg,thm:primitive_Dirichlet_Selberg,equ:non-primitive_Dirichlet_series_Euler_product}. 
      \end{proof}
