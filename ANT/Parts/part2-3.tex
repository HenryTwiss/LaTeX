\chapter{\texorpdfstring{$L$}{L}-functions of Arithmetic Functions}
  ...
  \section{The Prime Number Theorem}
    ...
    \begin{proof}[Proof of the explicit formula for $\psi(x)$]
      ...
      \end{equation}
      This is the first part of the proof. Now we estimate $J(x,T)$ by appealing to the residue theorem. Let $U \ge 1$ be an odd integer, $\W$ be the region enclosed by the contours $\eta_{1},\ldots,\eta_{4}$ in \cref{fig:explict_formula_zeta_contour}, and set $\eta = \sum_{1 \le i \le 4}\eta_{i}$ so that $\eta = \del \W$.
  ...
  \section{The Siegel-Walfisz Theorem}
    ...
    \begin{proof}[Proof of the explicit formula for $\psi(x,\chi)$]
      ...
      \end{equation}
      Now we estimate $J(x,T,\chi)$ by using the residue theorem. Let $U \ge 1$ be an integer with $U$ is even if $\chi$ is odd and odd if $\chi$ is even, $\W$ be the region enclosed by the contours $\eta_{1},\ldots,\eta_{4}$ in \cref{fig:explict_formula_Dirichlet_contour}, and set $\eta = \sum_{1 \le i \le 4}\eta_{i}$ so that $\eta = \del \W$. We may write $J(x,T,\chi)$ as
      \[
