\chapter{\texorpdfstring{$L$}{L}-functions of Number Fields}
  We introduce the $L$-functions attached to number fields known as Dedekind zeta functions. From the analytic properties of Dedekind zeta functions, we prove the infamous analytic class number formula and the Dirichlet class number formula. We then discuss Dedekind zeta functions attached to quadratic and cyclotomic number fields. Lastly, we use the Dirichlet class number formula to deduce estimates for the class numbers of quadratic number fields.
