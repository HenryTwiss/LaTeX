\chapter{The Theory of \texorpdfstring{$L$}{L}-functions}
  ...
  \section{The Approximate Functional Equation}
    ...
    \begin{theorem}
      ...
      \[
        \sum_{n \ge 1}a_{f}(n)\psi(n) = \frac{\e(f)}{\sqrt{q(f)}}\sum_{n \ge 1}a_{\conj{f}}(n)\phi(n)+R(f)\Psi(1),
      \]
  ...
  \section{Estimating the Central Value}
    ...
    \begin{theorem}
      ...
      \[
        L\left(\frac{1}{2},f\right) \ll_{\e} \max_{X \ll \sqrt{q(f)}}\left(\left|\frac{A_{\psi}(X)}{\sqrt{X}}\right|\right)+\left|\frac{R(f)}{q(f)^{\frac{1}{4}}}\right|,
      \]
    ...
    \begin{proof}
      ...
      \[
        L\left(\frac{1}{2},f\right) \ll \left|\sum_{n \ge 1}\frac{a_{f}(n)}{\sqrt{n}}V_{\frac{1}{2}}\left(\frac{n}{\sqrt{q(f)}}\right)\right|+\left|\frac{R(f)}{q(f)^{\frac{1}{4}}}\right|.
      \]
      ...
      \end{align*}
      where in the second to last line we have used that $V_{\frac{1}{2}}\left(\frac{n}{\sqrt{q(f)}}\right)$ is bounded for $n \ll \sqrt{\mf{q}\left(\frac{1}{2},f\right)} \ll \sqrt{q(f)}$, and then exhibits polynomial decay of arbitrarily large order thereafter by \cref{prop:V_function_decay}, and in the last line we have used that $\psi_{k}(y)$ has compact support in $[2^{k-1},2^{k+1}]$. Since $\s(y)$ is bounded away from zero and $\log(y) \ll y$, we obtain the crude bound
      \[
         \sum_{k \ll 1}\left|\sum_{2^{k-1}\sqrt{q(f)} \le n \le 2^{k+1}\sqrt{q(f)}}\frac{a_{f}(n)}{\sqrt{n}}\psi_{k}\left(\frac{n}{\sqrt{q(f)}}\right)\right| \ll \max_{X \ll \sqrt{q(f)}}\left(\left|\sum_{\frac{X}{2} \le n \le 2X}\frac{a_{f}(n)}{\sqrt{n}}\psi\left(\frac{n}{X}\right)\right|\right).
      \]
      ...
      we find that
      \[
        \max_{X \ll \sqrt{q(f)}}\left(\left|\sum_{\frac{X}{2} \le n \le 2X}\frac{a_{f}(n)}{\sqrt{n}}\psi\left(\frac{n}{X}\right)\right|\right) \ll \max_{X \ll \sqrt{q(f)}}\left(\left|\frac{A_{\psi}(X)}{\sqrt{X}}\right|\right).
      \]
      Putting everything together gives
      \[
        \sum_{n \ge 1}\frac{a_{f}(n)}{\sqrt{n}}V_{\frac{1}{2}}\left(\frac{n}{\sqrt{q(f)}}\right) \ll \max_{X \ll \sqrt{q(f)}}\left(\left|\frac{A_{\psi}(X)}{\sqrt{X}}\right|\right).
      \]
    \end{proof}
