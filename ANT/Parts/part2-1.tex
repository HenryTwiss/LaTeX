\chapter{Algebraic Integers}
  ...
  \section{Traces \& Norms}
    ...
    \begin{proof}
      ...
      \]
      which proves the first statement. The formulas for the trace and norm follow from Vieta's formulas and \cref{equ:trace_and_norm_characteristic_polynomial} which proves the second statement. Now suppose $L/K$ is Galois. Then $\Gal(L/K)$ consists of exactly the $K$-embeddings of $L$ into $\conj{K}$. Therefore the conjugates of $\l$ are exactly the images of $\l$ under these $K$-embeddings and the last claim follows.
    \end{proof}
