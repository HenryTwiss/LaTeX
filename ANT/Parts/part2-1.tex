\chapter{Algebraic Integers}
  ...
  \section{Dedekind Domains}
    ...
    Our third lemma says that if a Dedekind domain contains finitely many primes then it must be a principal ideal domain:
    ...
    Our last lemma shows that any fractional ideal is generated by at most two elements:
