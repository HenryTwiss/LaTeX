\chapter{Algebraic Integers}
  ...
  \section{\todo{Galois Extensions}}
    ...
    \]
    The decomposition field is aptly named because it contains all of the information about the different prime factors that $\mf{p}\mc{O}$ split into in $L$. In particular, the primes $\mf{P}^{D}$ are inert in $\mc{O}/\mc{O}^{D}$ as the following proposition shows:
