...
\section{Preliminaries}
    ...
    \end{theorem}
     ...
     We can now define the quadratic Dirichlet characters. For any $d \ge 1$, define the quadratic Dirichlet character $\chi_{d}$ by the following quadratic residue symbol:
    \[
