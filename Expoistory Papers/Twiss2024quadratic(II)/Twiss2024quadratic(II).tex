...
\section{Preliminaries}
    ...
    \]
    Now we recall characters on $\Z$. They are multiplicative functions $\chi:\Z \to \C$. The two flavors of characters of interest to use are: \todo{Characters modulo $8$ and no Hilbert symbols}
